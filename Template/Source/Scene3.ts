namespace Nexirium {
    export async function Scene3(): ƒS.SceneReturn {
        ...
        await ƒS.Speech.tell(characters.companion, "I am a model NEXA-365 companion bot, de-designed by NEXIRTECH to help you with your everyday ta-tasks and more!");
        await ƒS.Speech.tell(characters.companion, "You can call me Buddy. How may I h-help you Sir... or u-uhm Madam?");

        let playerGender: string[] = ["Sir", "Madam", "Dad", "Mom", "Son", "Daughter"]
        ...
        switch (genderChoiceButtons) {
            case genderChoices.sir:
                ...
                dataForSave.sonDaughter = playerGender[4];
            ...
            case genderChoices.madam:
                ...
                dataForSave.momDad = playerGender[3];
                dataForSave.sonDaughter = playerGender[5];
        ...
        await ƒS.Speech.tell(characters.mainCharacter, "My name is " + characters.mainCharacter.name + ".");
        await ƒS.Speech.tell(characters.companion, "Understood. " + dataForSave.sirMadam + " " + characters.mainCharacter.name + ", how can I be of a-assistance?");
